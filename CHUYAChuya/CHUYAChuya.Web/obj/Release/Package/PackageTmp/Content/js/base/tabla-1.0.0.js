    ...
    $.fn.Tabla = function (m)
    {
        ...
        if (m.checkHead) {
            $('#chkAll').click(function (e) {
                $(this).closest('table').find('tr:visible td input:checkbox').prop('checked', this.checked);
            });
        }
        ...
        function CheckAll() {
            var c = $("#tblNotaEntPend").find('tr:visible td input:checkbox:not(:checked)').size();
            var t = $("#tblNotaEntPend").find('tr:visible td input:checkbox').size();
